<template>
  <scroller class="scroller">
    <div class="wrapper">
      <text class="nav">specialPage页面</text>
      <div class="btn-group">
        <text class="font-title">特殊用例跳转</text>
        <text class="btn" @click="jumpPage('noExistPage')">push(noExistPage)</text>
        <text class="btn" @click="jumpPage('specialPage')">push(specialPage)</text>
