console.log('5. TestXXX webpack.harmony.conf.js, depend webpack.common.conf.js, config.js, helper.js, utils.js');
...
const generateHtmlWebpackPlugin = (entry) => {
  console.log('TestXXX generateHtmlWebpackPlugin');
...
console.log('TestXXX webpack.harmony.conf.js export harmonyConfig');
