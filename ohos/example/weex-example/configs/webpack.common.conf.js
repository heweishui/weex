console.log('6. TestXXX webpack.common.conf.js');
...
console.log('TestXXX webpack.common.conf.js process.platform:' + process.platform);
console.log('TestXXX webpack.common.conf.js ISHARMONY:' + process.env.ISHARMONY);
...
const getWebEntryFileContent = (entryPath, vueFilePath) => { // .temp/pages/index/entry.web.js, src/pages/index/entry.vue
  console.log('TestXXX webpack.common.conf.js getWebEntryFileContent');
...
const getEntryFile = (dir) => {
  console.log('TestXXX webpack.common.conf.js getEntryFile');
...
console.log('TestXXX webpack.common.conf.js export three config, webConfig、weexConfig and harmonyConfig');
